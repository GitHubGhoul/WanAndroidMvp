...
public interface ApiHelper {
    ...
    Single<BaseResponse<HomeArticle>> homeArticle(int page);
    ...
    //首页轮播图
    @GET("banner/json")
    Single<BaseResponse<Banner>> banner();

    //搜索文章
    @POST("article/query/{page}/json")
    @FormUrlEncoded
    Single<BaseResponse<HomeArticle>> queryArticle(int page, @Field("k") String k);

    //搜索作者文章
    @GET("article/query/{page}/json")
    Single<BaseResponse<HomeArticle>> queryAuthorArticle(int page, @Query("author") String author);

    //热词
    @GET("hotkey/json")
    Single<BaseResponse<Hotkey>> hotKey();
    ...
    //体系下文章
    @GET("article/list/{page}/json")
    Single<BaseResponse<TreeArticle>> treeArticle(int page, @Query("cid") String cid);
    ...
    //项目下文章
    @GET("article/list/{page}/json")
    Single<BaseResponse<ProjectArticle>> projectArticle(int page, @Query("cid") String cid);

    //最新项目
    @GET("article/listproject/{page}/json")
    Single<BaseResponse<ProjectList>> projectList(int page);
    ...
    Single<BaseResponse<WxArticle>> wxArticleHistory(int page, int id);

    //微信公众号搜索数据
    @GET("wxarticle/list/{id}/{page}/json")
    Single<BaseResponse<WxArticle>> wxArticleQuery(int page, int id, @Query("k") String k);

    //广场列表
    @GET("user_article/list/{page}/json")
    Single<BaseResponse<Square>> square(int page);

    //分享人对应列表
    @GET("user/{id}/share_articles/{page}/json")
    Single<BaseResponse<ShareUserArticle>> shareUserArticle(int page, int id);

    //自己分享的文章列表
    @GET("user/lg/private_articles/{page}/json")
    Single<BaseResponse<ShareUserArticle>> sharePersonalArticle(int page);

    //删除自己分享的文章
    @POST("lg/user_article/delete/{id}/json")
    Single<BaseResponse<Object>> deletePersonalArticle(int id);
    ...
    Single<BaseResponse<HomeArticle>> wenda(int page);

    //收藏列表
    @GET("lg/collect/list/{page}/json")
    Single<BaseResponse<CollectArticle>> collectList(int page);

    //收藏站内文章
    @POST("lg/collect/{id}/json")
    Single<BaseResponse<Object>> collectInArticle(int id);
    ...
    Single<BaseResponse<Object>> cancelListCollect(int id);

    //取消我的收藏
    @POST("lg/uncollect/{id}/json")
    @FormUrlEncoded
    Single<BaseResponse<Object>> cancelMyCollect(int id, @Field("originId") String originId);
    ...
    Single<BaseResponse<IntegralRank>> integralRank(int page);
    ...
    Single<BaseResponse<IntegralHistory>> integralHistory(int page);

    //获取todo列表
    @GET("lg/todo/v2/list/{page}/json")
    Single<BaseResponse<Todo>> todoList(int page);
    ...
    @FormUrlEncoded
    Single<BaseResponse<Todo.DatasBean>> updateStatusTodo(int id, @Field("status") int status);

    //删除todo
    @POST("lg/todo/delete/{id}/json")
    Single<BaseResponse<Object>> deleteTodo(int id);
}